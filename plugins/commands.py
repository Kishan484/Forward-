...
main_buttons = [[
    ...
    InlineKeyboardButton('💐 KISHAN YADAV 💐', url='https://t.me/OS_GOOD_LOVE'),
    InlineKeyboardButton('🤪ANY HELP', url='https://t.me/Xyzinternetby')
],[
    InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/hilvlmovie')
],[
