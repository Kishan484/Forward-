...
class Config:
    API_ID = int(environ.get("API_ID", "29601499"))
    API_HASH = environ.get("API_HASH", "7589031868:AAGfZ3Z4WIzW-iYg42kr94lBTsXQlVPkmcc)
    ...
    BOT_OWNER = int(environ.get("BOT_OWNER", "6979485594"))
